...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2019 at 01:51 PM
...
CREATE TABLE `dogs` (
  ...
  `dogs_name` varchar(250) COLLATE utf8_bin NOT NULL,
  `dogs_breed` varchar(250) COLLATE utf8_bin NOT NULL,
  `dogs_info` varchar(250) COLLATE utf8_bin NOT NULL,
  `dogs_gender` varchar(250) COLLATE utf8_bin NOT NULL,
  `dogs_type` int(11) NOT NULL DEFAULT '0',
  `dogs_img` varchar(250) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `dogs` (`dogs_id`, `dogs_name`, `dogs_breed`, `dogs_info`, `dogs_gender`, `dogs_type`, `dogs_img`, `create_by`, `create_at`) VALUES
(95, 'แอม', 'ไทย', 'ขนดกดำ ผสมพันธุ์เก่ง', 'เพศผู้', 0, 'dog_5dbd244e5ec25.jpg', 120, '2019-11-02 13:38:06'),
(96, 'DDD', 'ไทย', 'ddd', 'เพศผู้', 0, 'dog_5dbd51ba278e1.jpg', 120, '2019-11-02 16:51:54'),
(97, 'DDD', 'ddd', 'sss', 'เพศเมีย', 0, 'dog_5dbd52168628e.jpg', 120, '2019-11-02 16:53:26'),
(98, 'ss', 'ss', 'ขนสีดำ ตัวสีขาว', 'เพศเมีย', 0, 'dog_5dbd52472b6b0.jpg', 120, '2019-11-02 16:54:15'),
(99, 'ss', 'ss', 'ขนสีดำ ตัวสีขาว', 'เพศผู้', 0, 'dog_5dbd5292c7d8f.jpg', 120, '2019-11-02 16:55:30'),
(100, 'lksjadl;kfj', 'kljsd;alfkj', 'lj;lj;', 'เพศเมีย', 0, 'dog_5dbd52a49c45c.jpg', 120, '2019-11-02 16:55:48'),
(101, 'แอมน้อย', 'อะไรไม่รู็', 'ขนสีน้ำตาล', 'เพศผู้', 0, 'dog_5dbe4da5391f6.jpg', 121, '2019-11-03 10:46:45');
...
CREATE TABLE `profile_users` (
  `profile_users_name` varchar(250) COLLATE utf8_bin DEFAULT 'สถานสงเคราะห์ไม่ได้ระบุ',
  `profile_users_detail1` varchar(250) COLLATE utf8_bin DEFAULT 'รายละเอียดที่อยู่ไม่ได้ระบุ',
  `profile_users_detail2` varchar(250) COLLATE utf8_bin DEFAULT 'รายละเอียดความต้องการไม่ได้ระบุ',
  `profile_users_province` int(11) NOT NULL,
  `profile_users_create_at` varchar(250) COLLATE utf8_bin NOT NULL,
  `profile_users_geo` int(11) NOT NULL,
  `profile_users_amp` int(11) NOT NULL,
  `profile_users_district` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `profile_users` (`profile_users_name`, `profile_users_detail1`, `profile_users_detail2`, `profile_users_province`, `profile_users_create_at`, `profile_users_geo`, `profile_users_amp`, `profile_users_district`) VALUES
('หจก.จันทบุรีเกษตร', 'อยู่ตรงข้ามกับภูเขาไฟฟูจิ', 'ต้องการ รับบริจาคอาหารสุนัข เนื่องจาก จำนวนหมาที่ปากป่องภูเขาไฟมีจำนวนมาก ผู้ที่มีความประสงค์ต้องการบริจากเป็นอาการสามารถส่งมาได้ ตามที่อยู่ที่ปรากฎ แต่ถ้าหากไม่สะดวก สามารถ โอนมายังหมายเลข บัญชี XXX-XXX-XXX-X ธนาการกรุงเทพ ได้ ขอขอบคุณ', 13, '120', 5, 160, 1268),
('GUMI thailand', '', '', 38, '121', 1, 573, 5176);
...
CREATE TABLE `users` (
  ...
  `users_usersname` varchar(250) COLLATE utf8_bin NOT NULL,
  `users_password` varchar(250) COLLATE utf8_bin NOT NULL,
  `users_role` int(11) NOT NULL,
  `users_create_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `users` (`users_id`, `users_usersname`, `users_password`, `users_role`, `users_create_at`) VALUES
(120, 'kewkew5588', '123456', 0, '2019-10-26 13:11:44'),
(121, 'ritichiaj', '123456', 0, '2019-11-03 10:39:21');
...
ALTER TABLE `profile_users`
  ADD PRIMARY KEY (`profile_users_create_at`);
...
--
ALTER TABLE `dogs`
  MODIFY `dogs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
