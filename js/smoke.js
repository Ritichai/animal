...
(function($) {
  ...
  */
  $.smkConfirm = function(options, callback) {
    ...
    $('body').append('<div class="smk-confirm-back">\n\
<div class="card card-default smk-confirm" tabindex="1">\n\
<div class="card-body">' + settings.text + '</div>\n\
<div class="card-footer text-right">\n\
<a class="btn btn-danger btn-sm smk-cancel" href="#" >' + settings.cancel + '</a> \n\
<a class="btn btn-success btn-sm smk-accept" href="#">' + settings.accept + '</a>\n\
</div>\n\
</div>\n\
</div>');
